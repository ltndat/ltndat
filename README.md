...
Currently leading [**@Vaberio**](https://github.com/Vaberio) as **Founding Engineer**, where I apply these systems in real-world product pipelines — designed with [**@Smindlab**](https://github.com/smindlab) principles.
