...
Currently leading [**@Mindfrm**](https://github.com/mindfrm) as **Technical Lead**, where I apply these systems in real-world product pipelines — designed with [**@Smindlab**](https://github.com/smindlab) principles.
